...
public class FaltuPuzzelsIndex extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        puzzels=getResources().getStringArray(R.array.faltu);
        ...
        brainpuzzel.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent i = new Intent(FaltuPuzzelsIndex.this,FaltuPuzzelsSolve.class);
