...
public class FunnyPuzzelsIndex extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        puzzels=getResources().getStringArray(R.array.funny);
        ...
        brainpuzzel.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent i = new Intent(FunnyPuzzelsIndex.this,FunnyPuzzelsSolve.class);
