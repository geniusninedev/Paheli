...
public class KidsPuzzelsIndex extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        puzzels=getResources().getStringArray(R.array.kids);
        ...
        brainpuzzel.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent i = new Intent(KidsPuzzelsIndex.this,KidsPuzzelSolve.class);
