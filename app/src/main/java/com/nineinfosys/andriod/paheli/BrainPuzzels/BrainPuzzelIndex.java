...
public class BrainPuzzelIndex extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        puzzels=getResources().getStringArray(R.array.brain);
        ...
        brainpuzzel.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent i = new Intent(BrainPuzzelIndex.this,BrainPuzzelSolve.class);
