...
public class WhatsAppPuzzelsIndex extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        puzzels=getResources().getStringArray(R.array.whatsapp);
        ...
        brainpuzzel.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent i = new Intent(WhatsAppPuzzelsIndex.this,WhatsAppPuzzelsSolve.class);
